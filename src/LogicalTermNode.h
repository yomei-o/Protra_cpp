...
#ifndef DF_LOGICALTERMNODE_H_
#define DF_LOGICALTERMNODE_H_

#include "ExpressionNode.h"
#include "EquivalenceComparisonNode.h"
namespace Protra {
namespace Lib {
namespace Lang {

class LogicalTermNode : public ExpressionNode
{
public:
    ...
    std::shared_ptr<ExpressionNode> Parse(std::shared_ptr<ExpressionNode>& that,Scanner& scanner)override
    {
        ...
        std::shared_ptr<ExpressionNode> node = std::shared_ptr<ExpressionNode>(new EquivalenceComparisonNode());
        ...
        {   
            scanner.Scan();
            std::shared_ptr<ExpressionNode> tmp = std::shared_ptr<ExpressionNode>(new EquivalenceComparisonNode());
