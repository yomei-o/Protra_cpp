...
#ifndef DF_ARITHMETNODE_H_
#define DF_ARITHMETNODE_H_

#include "ExpressionNode.h"
#include "ArithmeticTermNode.h"
...
public:
    ...
    std::shared_ptr<ExpressionNode> Parse(std::shared_ptr<ExpressionNode>& that, Scanner& scanner)override
    {
        ...
        std::shared_ptr<ExpressionNode> node = std::shared_ptr<ExpressionNode>(new ArithmeticTermNode());
        ...
        do
        {
            ...
            scanner.Scan();
            std::shared_ptr<ExpressionNode> tmp = std::shared_ptr<ExpressionNode>(new ArithmeticTermNode());
